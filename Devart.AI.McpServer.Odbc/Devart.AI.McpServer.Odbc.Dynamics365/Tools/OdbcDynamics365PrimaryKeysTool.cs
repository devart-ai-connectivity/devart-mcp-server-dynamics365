// --------------------------------------------------------------------------
// <copyright file="OdbcDynamics365PrimaryKeysTool.cs" company="Devart">
//
...
namespace Devart.AI.McpServer.Odbc.Dynamics365.Tools
{
  internal sealed class OdbcDynamics365PrimaryKeysTool(McpConfiguration serverConfiguration) : PrimaryKeysTool(serverConfiguration)
  {
